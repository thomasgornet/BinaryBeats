...
#
# Generated by Vivado on Mon Apr 14 21:42:10 -0500 2025
...
simulate()
{
  xsim  clk_wiz_1 -key {Behavioral:sim_1:Functional:clk_wiz_1} -tclbatch cmd.tcl -protoinst "protoinst_files/mb_block.protoinst" -log simulate.log
}
