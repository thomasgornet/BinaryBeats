...
always_comb begin
    ...
    if(score[29:29] == 1'b1) begin
        ...
        if(drawX > 269 && drawX <334 && drawY > 99 && drawY < 116) begin
            tempX = drawX - 270;
            tempY = drawY - 100;
            case(tempX[5:3])
                3'b010: character = score[31:28] + 8'h2F;
            ...
            if(drawX > 269 && drawX <334 && drawY > 49 && drawY < 66) begin
            tempX = drawX - 270;
            tempY = drawY - 50;
            case(tempX[5:3])
                3'b010: character = high_score[31:28] + 8'h2F;
            ...
            if(score[28:28] == 1'b1) begin
                if(drawX > 269 && drawX <334 && drawY > 24 && drawY < 41) begin
                tempX = drawX - 270;
                tempY = drawY - 75;
                case(tempX[5:3])
                3'b010: character = 8'h2D;
            ...
            endcase
                ...
                if(drawX > 269 && drawX <334 && drawY > 74 && drawY < 91) begin
                tempX = drawX - 270;
                tempY = drawY - 25;
                case(tempX[5:3])
                3'b010: character = 8'h4F;
