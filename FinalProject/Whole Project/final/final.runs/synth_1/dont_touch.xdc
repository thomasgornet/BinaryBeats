...
# IP: bd/mb_block/ip/mb_block_dlmb_v10_3/mb_block_dlmb_v10_3.xci
set_property KEEP_HIERARCHY SOFT [get_cells -hier -filter {REF_NAME==mb_block_dlmb_v10_3 || ORIG_REF_NAME==mb_block_dlmb_v10_3} -quiet] -quiet

# IP: bd/mb_block/ip/mb_block_ilmb_v10_3/mb_block_ilmb_v10_3.xci
set_property KEEP_HIERARCHY SOFT [get_cells -hier -filter {REF_NAME==mb_block_ilmb_v10_3 || ORIG_REF_NAME==mb_block_ilmb_v10_3} -quiet] -quiet

# IP: bd/mb_block/ip/mb_block_dlmb_bram_if_cntlr_3/mb_block_dlmb_bram_if_cntlr_3.xci
set_property KEEP_HIERARCHY SOFT [get_cells -hier -filter {REF_NAME==mb_block_dlmb_bram_if_cntlr_3 || ORIG_REF_NAME==mb_block_dlmb_bram_if_cntlr_3} -quiet] -quiet

# IP: bd/mb_block/ip/mb_block_ilmb_bram_if_cntlr_3/mb_block_ilmb_bram_if_cntlr_3.xci
set_property KEEP_HIERARCHY SOFT [get_cells -hier -filter {REF_NAME==mb_block_ilmb_bram_if_cntlr_3 || ORIG_REF_NAME==mb_block_ilmb_bram_if_cntlr_3} -quiet] -quiet

# IP: bd/mb_block/ip/mb_block_lmb_bram_3/mb_block_lmb_bram_3.xci
set_property KEEP_HIERARCHY SOFT [get_cells -hier -filter {REF_NAME==mb_block_lmb_bram_3 || ORIG_REF_NAME==mb_block_lmb_bram_3} -quiet] -quiet
...
# XDC: c:/Users/sircu/ECE385/final/final.gen/sources_1/bd/mb_block/mb_block_ooc.xdc
