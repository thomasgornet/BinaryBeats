...
HD_PWD='C:/Users/lukej/ECE_385/Final_Project/final/final.runs/mb_block_lmb_bram_3_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log mb_block_lmb_bram_3.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source mb_block_lmb_bram_3.tcl
